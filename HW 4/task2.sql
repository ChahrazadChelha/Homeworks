...
-- /* 3rd update */ 
INSERT INTO petPet VALUES    
    ('kitten1','harold','cat','F',NULL,NULL),
    ('kitten2','harold','cat','F',NULL,NULL),
    ('kitten3','harold','cat','F',NULL,NULL),
    ('kitten4','harold','cat','M',NULL,NULL),
    ('kitten5','harold','cat','M',NULL,NULL);
